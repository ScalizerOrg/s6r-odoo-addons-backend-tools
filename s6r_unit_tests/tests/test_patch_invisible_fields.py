...
from odoo.addons.base.tests.test_views import TestInvisibleField
...
def patched_test_uncommented_invisible_field(self):
    ...
    oca_modules = set(
        ...
        .search(
            [
                ("state", "=", "installed"),
                ("author", "ilike", "Odoo Community Association"),
            ]
        )
        .mapped("name")
    )
...
TestInvisibleField.test_uncommented_invisible_field = patched_test_uncommented_invisible_field
